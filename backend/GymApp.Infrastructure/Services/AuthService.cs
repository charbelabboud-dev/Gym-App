        ...
        public async Task<AuthResponseDto> RegisterAsync(RegisterDto registerDto)
        {
            ...
            if (registerDto.Role == "Client")
            {
                var client = new Client
                {
                    ...
                    ClLname = registerDto.FullName.Split(' ').Length > 1
                        ? registerDto.FullName.Split(' ')[1]
                        : "",
            ...
            else if (registerDto.Role == "Coach")
            {
                var coach = new Coach
                {
                    ...
                    CoLname = registerDto.FullName.Split(' ').Length > 1
                        ? registerDto.FullName.Split(' ')[1]
                        : "",
            ...
            else if (registerDto.Role == "Dietitian")
            {
                var dietitian = new Dietitian
                {
                    ...
                    DietLname = registerDto.FullName.Split(' ').Length > 1
                        ? registerDto.FullName.Split(' ')[1]
                        : "",
        ...
        public async Task<AuthResponseDto> LoginAsync(LoginDto loginDto)
        {
            ...
            else if (user.UserRole == "Dietitian")
            {
                ...
                if (dietitian != null)
                {
                    ...
                    dietitianCode = dietitian.DietCode;
                }
            }
